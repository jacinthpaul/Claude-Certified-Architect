# Architect – Foundations tutorial PDFs

Downloadable companion handbooks for the Architect Foundations console.

This whole folder is copied verbatim into the deployed console by
`.github/workflows/pages.yml` (`cp -r ui/console/. _site/architect-foundations/`),
so a file dropped here is immediately reachable at:

    https://jacinthpaul.github.io/Claude-Certified-Architect/architect-foundations/tutorials/<file>.pdf

## Adding another tutorial

1. Drop the PDF here using the naming convention
   `claude-certified-architect-foundations-tutorial-<n>.pdf`.
